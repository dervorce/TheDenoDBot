...
async def on_message(message):
    if message.author.id in [1375130091725783150,412329858471821314]:
...
async def main():
    ...
    if not TOKEN:
        raise ValueError("this RETARD really forgot his bot token, this could NOT have been me brah 💀💀💀 bro is NOT getting hired at software development, bro is COOKED, mods kill this guy with hammers and sneak poison in his drinks, expire his ass and send him to the gulag")
...
if __name__ == "__main__":
    try:
        ...
        # Already in an event loop? Run main manually (for Jupyter / weird environments)
